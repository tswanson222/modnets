...
You can install the released version of the package from [CRAN](https://CRAN.R-project.org), or the development version from [GitHub](https://github.com/tswanson222/modnets) with:
