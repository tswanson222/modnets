##### resample: bootstrapping or multi-sample splits for variable selection ***FITOBJ***
resample <- function(data, m = NULL, niter = 10, sampMethod = "split", criterion = "AIC",
  ...
  if(nCores > 1 | isTRUE(nCores)){return(do.call(resample_parallel, as.list(match.call())[-1]))}
