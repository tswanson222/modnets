...
R package for moderated network models.

## Installation

You can install the developmental version of modnets from
[GitHub](https://github.com/tswanson222/modnets) with:

``` r
# library(devtools)
# devtools::install_package('tswanson222/modnets')
```

Designed to afford exploratory and confirmatory estimation of 3 types of
moderated networks:
...
-   For bootstrapping/edge-weight accuracy analysis, you can use the
    `bootNet` function (the name will be changed, given the popularity
    of the `bootnet` function by Sacha Epskamp that my code is based
    on).
...
#> Time difference of 4.784567 secs
str(x)
#> List of 6
...
#>  - attr(*, "class")= chr [1:2] "list" "mgmSim"
#>  - attr(*, "time")= 'difftime' num 4.78435754776001
#>   ..- attr(*, "units")= chr "secs"
### Contents:
...
#> Fitting model 4/5...  Complete! (0.05 secs)
