...
#' A wrapper for simNet to prevent failure
#'
#' Possibly not even prevent, just stall.
#'
#' @param ... simNet arguments
#' @param nets something
#' @param maxiter numeric
#' @param pbar logical
#' @param div numeric
#' @param divup logical
#' @param maxdiv numeric
#' @param errors logical
#' @param nostop logical
#'
#' @return simNet output
#' @export
#'
#' @examples
#' 1 + 1
